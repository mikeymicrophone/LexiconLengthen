...
/// Tracks user's writing mastery for a specific word.
@Model
final class WordWritingMastery {
    ...
    /// Number of times written correctly
    var correctCount: Int

    /// Number of times written incorrectly
    var incorrectCount: Int

    /// Date of last writing check
    var lastReviewedAt: Date?

    /// Total points earned from writing this word
...
extension WordWritingMastery {
    /// Returns true if this word has been mastered for writing (level 5)
    var isMastered: Bool {
        masteryLevel >= 5
    }
    ...
    /// Records a writing attempt and updates mastery
